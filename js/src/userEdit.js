...
var userEdit=(function(){
    return {
        ...
        tabItemClickHandler:function(el){
...
$(document).ready(function(){
    $("#userEditForm").validate({
        ...
        messages: {
            username:{
                ...
                rangelength:config.ownInvalidMessage.maxlength.replace("${max}",30)
            },
            fullname:{
                required:config.ownInvalidMessage.required,
    ...
    $("#userPwdForm").validate({
        ...
        submitHandler:function(form) {
            userEdit.pwdFormSubmit(form);
        }
    });

    $("#tab a").click(function(){
        userEdit.tabItemClickHandler($(this));
